...
function create_libertyMaterial(){
  return new THREE.MeshLambertMaterial({
    ...
    alphaMap: new THREE.TextureLoader().load('./filter/assets/libertyAlphaMapSoft512.png'),
    transparent: true,
...
function init_threeScene(spec){
  ...
  libertyLoader.load('./filter/assets/liberty.json', function(libertyGeometry){
  ...
  new THREE.BufferGeometryLoader().load('./filter/assets/libertyFaceMask.json', function(faceGeometry){
