...
function init_threeScene(spec, url){
  ...
  tigerMaskLoader.load(url+'/TigerHead.json', function(tigerMaskGeom){
    const tigerFaceSkinMat = build_customMaskMaterial(url+'/headTexture2.png', videoTransformMat2);
    const tigerEyesMat = build_customMaskMaterial(url+'/white.png', videoTransformMat2);
